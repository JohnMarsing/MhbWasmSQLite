...
namespace MhbWasmSQLite.Client.GlobalEnums;
...
public abstract class Link : SmartEnum<Link>
{
	...
	public static readonly Link Parasha = new ParashaSE();
...
*/
	public static readonly Link Article = new ArticleSE();
	public static readonly Link FavoriteVerses = new FavoriteVersesSE();
	public static readonly Link Hebrew = new HebrewSE();
	public static readonly Link AlephTavs = new AlephTavsSE();
	public static readonly Link BibleList = new BibleListSE();
	public static readonly Link Teaching = new TeachingSE();
	public static readonly Link Sitemap = new SitemapSE();
	public static readonly Link BibleSearch = new BibleSearchSE();
	...
	*/
	...
	private sealed class HebrewSE : Link
	{
	...
	private sealed class HomeMhbVer6SE : Link
	{
